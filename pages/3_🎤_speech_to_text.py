...
# if 'bImage' not in st.session_state:
#     st.session_state['bImage'] = []
# if 'bTitle' not in st.session_state:
#     st.session_state['bTitle'] = []
# if 'bStructure' not in st.session_state:
#     st.session_state['bStructure'] = []
# if 'bContent' not in st.session_state:
#     st.session_state['bContent'] = []
# if 'bSEO' not in st.session_state:
#     st.session_state['bSEO'] = []
# if 'bLinks' not in st.session_state:
#     st.session_state['bLinks'] = []
# if 'bSave' not in st.session_state:
